firstnum = document.URL.substring(document.URL.lastIndexOf("/") + 1, document.URL.length - 7);
secondnum = document.URL.substring(document.URL.lastIndexOf("/") + 3, document.URL.length - 5);
$("html").attr("lang", "kr");
...
function end() {
  document.write('<div style="font-size:36px; margin-top:calc(50vh - 25px); color:#000; width:96vw; text-align:center; font-family:AppleSDGothicNeoL;" onclick="toSurvey();">수고하셨습니다.</div>');
